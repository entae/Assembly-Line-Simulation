...
namespace sdds {
	...
	struct Profile {
		...
		void validateAddress() {
			...
			// 	throw std::runtime_error("Invalid address: Street number cannot be negative.");
			// }

			// if (m_address.street.empty()) {
			// 	throw std::runtime_error("Invalid address: Street name cannot be empty.");
			// }
